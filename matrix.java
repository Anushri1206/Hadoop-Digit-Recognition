...
class Matrix{
    ...
    public Matrix (double value[], int m) {
        ...
        //if m != 0 is true, n = value.length/m, else n = 0
        if (m * n != value.length) {
    ...
    //Check whether two matrices can perform arithmetic computing with each other.
...
//Copy double array type and return double array type
    ...
    //Return the result of the element by element plus, the result is assigned to the original matrix.
...
//Return the result of the element-by-element minus, the result is assigned to the original matrix.
    ...
    //Return the result of the element-by-element multiplication, the result is assigned to the original matrix or another variable.
    ...
    //Return the result of the element-by-element minus, the result is assigned to the original matrix or another variable.
