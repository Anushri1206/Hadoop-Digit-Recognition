...
public class DeepLearningDriver extends Configured implements Tool
{
    ...
    {
        /*
         * This is the format of command-line arguments
         * /input_file/ /output_file/ maxiter layernum nodeNumofLayer1 nodeNumofLayer2 ...
         */
...
*/
            ...
            for(int iter = 1; iter <= maxEpoch / epochInMapper; iter++)
            {
                ...
                */
                ...
                // Manually set the needed classes
                ...
                if(useDistributedCache == "1")
                {
                    ...
                    for(int ri = 0; ri < numdims * numhid; ri++)
                    {
                        /* This loop is to put all the weights into a string split by space. Later, it will output to distributed cache position
                         */
                ...
                {
                  //This branch is to use configuration to pass weights
